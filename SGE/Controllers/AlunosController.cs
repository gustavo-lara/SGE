...
namespace SGE.Controllers
{
	public class AlunosController : Controller
	{
		...
		public async Task<IActionResult> Create(
			...
			"UrlFoto")] Alunos aluno, string ConfirmeSenha, IFormFile UrlFoto)
		{
		...
		[HttpPost]
		[ValidateAntiForgeryToken]
		public async Task<IActionResult> Edit(Guid id, [Bind("AlunoId,Matricula,AlunoNome,Email,Celular,Logradouro,Numero,Cidade,Estado,CEP,Senha,DataNascimento,CadAtivo,DataCadastro,CadInativo,TipoUsuarioId,UrlFoto")] Alunos aluno, string ConfirmeSenha)
		{
			if (id != aluno.AlunoId)
			{
				return NotFound();
		...
		public async Task<IActionResult> AlterarFoto(Guid id, IFormFile novaFoto)
		{
			...
			Alunos aluno = await _context.Alunos.FindAsync(id);
